...
export const PERSONAS = [
  {
    ...
    bio: () => t('personaDempseyBio'),
    traits: [() => t('personaDempseyT1'), () => t('personaDempseyT2'), () => t('personaDempseyT3')],
  ...
  },
  {
    ...
    bio: () => t('personaNikolaiBio'),
    traits: [() => t('personaNikolaiT1'), () => t('personaNikolaiT2'), () => t('personaNikolaiT3')],
  ...
  },
  {
    ...
    bio: () => t('personaTakeoBio'),
    traits: [() => t('personaTakeoT1'), () => t('personaTakeoT2'), () => t('personaTakeoT3')],
  ...
  },
  {
    ...
    bio: () => t('personaRichtofenBio'),
    traits: [() => t('personaRichtofenT1'), () => t('personaRichtofenT2'), () => t('personaRichtofenT3')],
